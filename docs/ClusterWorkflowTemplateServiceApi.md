# workflows.client.ClusterWorkflowTemplateServiceApi
...
body = workflows.client.V1alpha1ClusterWorkflowTemplateCreateRequest() # V1alpha1ClusterWorkflowTemplateCreateRequest | 
...
# create an instance of the API class
api_instance = workflows.client.ClusterWorkflowTemplateServiceApi()
body = workflows.client.V1alpha1ClusterWorkflowTemplateLintRequest() # V1alpha1ClusterWorkflowTemplateLintRequest | 
