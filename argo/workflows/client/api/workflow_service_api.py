...
class WorkflowServiceApi(object):
    ...
    def list_workflows_with_http_info(self, namespace, **kwargs):  # noqa: E501
        ...
        all_params = ['namespace', 'list_options_label_selector', 'list_options_field_selector', 'list_options_watch', 'list_options_allow_watch_bookmarks', 'list_options_resource_version', 'list_options_timeout_seconds', 'list_options_limit', 'list_options_continue', 'fields']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def stop_workflow(self, namespace, name, body, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.stop_workflow_with_http_info(namespace, name, body, **kwargs)  # noqa: E501
            return data
    ...
    def stop_workflow_with_http_info(self, namespace, name, body, **kwargs):  # noqa: E501
        ...
        if ('namespace' not in params or
                params['namespace'] is None):
            raise ValueError("Missing the required parameter `namespace` when calling `stop_workflow`")  # noqa: E501
        # verify the required parameter 'name' is set
        if ('name' not in params or
                params['name'] is None):
            raise ValueError("Missing the required parameter `name` when calling `stop_workflow`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `stop_workflow`")  # noqa: E501
    ...
    def submit_workflow(self, namespace, body, **kwargs):  # noqa: E501
        ...
        if kwargs.get('async_req'):
            ...
            (data) = self.submit_workflow_with_http_info(namespace, body, **kwargs)  # noqa: E501
            return data
    ...
    def submit_workflow_with_http_info(self, namespace, body, **kwargs):  # noqa: E501
        ...
        if ('namespace' not in params or
                params['namespace'] is None):
            raise ValueError("Missing the required parameter `namespace` when calling `submit_workflow`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `submit_workflow`")  # noqa: E501
