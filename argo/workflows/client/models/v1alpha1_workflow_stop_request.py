...
class V1alpha1WorkflowStopRequest(object):
    ...
    def __init__(self, message=None, name=None, namespace=None, node_field_selector=None):  # noqa: E501
        """V1alpha1WorkflowStopRequest - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha1WorkflowStopRequest, dict):
