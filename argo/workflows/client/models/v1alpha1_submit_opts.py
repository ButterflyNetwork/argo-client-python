...
class V1alpha1SubmitOpts(object):
    ...
    def __init__(self, dry_run=None, entry_point=None, generate_name=None, labels=None, name=None, owner_reference=None, parameter_file=None, parameters=None, server_dry_run=None, service_account=None):  # noqa: E501
