...
class V1alpha1SubmitOpts(object):
    ...
    def __init__(self, dry_run=None, entry_point=None, generate_name=None, instance_id=None, labels=None, name=None, owner_reference=None, parameter_file=None, parameters=None, server_dry_run=None, service_account=None):  # noqa: E501
        """V1alpha1SubmitOpts - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha1SubmitOpts, dict):
