...
class V1alpha1S3Artifact(object):
    ...
    def __init__(self, access_key_secret=None, bucket=None, endpoint=None, insecure=None, key=None, region=None, role_arn=None, secret_key_secret=None, use_sdk_creds=None):  # noqa: E501
