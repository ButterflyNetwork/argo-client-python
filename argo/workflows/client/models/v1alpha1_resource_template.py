...
class V1alpha1ResourceTemplate(object):
    ...
    def __init__(self, action=None, failure_condition=None, flags=None, manifest=None, merge_strategy=None, set_owner_reference=None, success_condition=None):  # noqa: E501
