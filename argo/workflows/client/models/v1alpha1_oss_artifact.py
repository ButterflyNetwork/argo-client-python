...
class V1alpha1OSSArtifact(object):
    ...
    def __init__(self, access_key_secret=None, bucket=None, endpoint=None, key=None, secret_key_secret=None):  # noqa: E501
        """V1alpha1OSSArtifact - a model defined in Swagger"""  # noqa: E501
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(V1alpha1OSSArtifact, dict):
